...
1. [docker](https://docker.com) - this article applications are deployed via docker, so you might need basic knowledge about docker and docker-compose for example how to run, view log, or even stop it.
